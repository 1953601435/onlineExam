<template>
    <div class="content-container" direction="vertical">
        <el-container class="content-row">
            <div class="info">总考试学生：{{this.data.allTra}}</div>
            <div class="info">考试题数：{{this.data.speTra}}</div>
            <div class="info">软工正确率：{{this.data.norTra}}</div>
            <div class="info">数媒正确率：{{this.data.userCount}}</div>
            <div class="info">通信正确率：{{this.data.managerCount}}</div>
        </el-container>
        <el-container class="content-row">
